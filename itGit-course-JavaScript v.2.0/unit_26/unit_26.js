...
function t2() {
fetch('http://getpost.itgid.info/index2.php?auth=7859d9d42a8834141d529577207c9596&action=2&name=dimon')
.then(data => data.text())
.then(data => {
...
function t3() {
fetch('http://getpost.itgid.info/index2.php?auth=7859d9d42a8834141d529577207c9596&action=3&num1=1&num2=12')
.then(data => data.text())
.then((data) => {
...
function t4() {
    fetch('http://getpost.itgid.info/index2.php?auth=7859d9d42a8834141d529577207c9596&action=4&num1=1&num2=16')
    .then((data) => {
        return data.text();
    })
    .then((data) => {
...
function t6() {
    fetch('http://getpost.itgid.info/index2.php?auth=7859d9d42a8834141d529577207c9596&action=6&num1=6&num2=18')
    .then(function(data) {
        return data.text();
    })
    .then( function(data2) {
        document.querySelector('.out-6').innerHTML = data2;
    })
}
...
fetch('http://getpost.itgid.info/index2.php', {
    ...
    headers: {
      ...
      body: 'auth=7859d9d42a8834141d529577207c9596&action=2&name=dima',
      })
      .then(data => data.text())
      .then(data => {
...
function t12() {
    fetch('http://getpost.itgid.info/index2.php', {
        ...
        headers: {
          ...
          body: 'auth=7859d9d42a8834141d529577207c9596&action=3&num1=22&num2=16',
          })
          .then(data => data.text())
          .then(data => {
...
fetch('http://getpost.itgid.info/index2.php', {
    ...
    headers: {
      ...
      body: 'auth=7859d9d42a8834141d529577207c9596&action=4&num1=22&num2=16',
      })
      .then( data => data.text())
      .then( data => {
...
function t15() {
    fetch('http://getpost.itgid.info/index2.php', {
        ...
        headers: {
          ...
          body: 'auth=7859d9d42a8834141d529577207c9596&action=6&num1=22&num2=16',
          })
          .then( data => data.text())
          .then( data => {
