...
function f4(){
const accessAge = 2004;
let ageUser = Number(document.querySelector('.i-4').value);
let answer = document.querySelector(".out-4");

if( ageUser <= accessAge) {
   answer.innerHTML = 1;
}else {
   answer.innerHTML = 0;
}
...
function f5(){
let input5 = Number(document.querySelector(".i-5").value);
...
function f6(){
let input6 = Number(document.querySelector('.i-6').value);
...
document.querySelector(".out-7").innerHTML = Math.pow(input71, input72);
}
...
switch (select) {
   case '1': out.innerHTML = "one"
   break;
   case '2': out.innerHTML = "two"
   break;
   case '3': out.innerHTML = "three"
   break;
}
}
...
document.querySelector(".out-10").innerHTML = select.value;
};
