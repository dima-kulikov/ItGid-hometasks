...
const f2 = () => {
    let iputValue = +document.querySelector('.i-2').value;
    let outTeg = document.querySelector('.out-2');
    let arrNumber = a2.indexOf(iputValue);
    if( arrNumber !== -1) {
        outTeg.innerHTML = arrNumber;
    }else {
        outTeg.innerHTML = 'false';
    }
}
...
const f5 = () => {
    ...
    document.querySelector('.out-5').innerHTML = a5.indexOf(first, second);
}
...
const f6 = () => {
    ...
    document.querySelector('.out-6').innerHTML = a6.indexOf(inputValue);
}
...
const f7 = (arr, elem) => {
    ...
    for(let i = 0; i < arr.length; i++) {
        ...
        console.log(elem)
        if( arr[i] === elem){
         return document.querySelector('.out-7').innerHTML = i;
        }else{
