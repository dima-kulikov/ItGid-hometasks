...
const f1 = () => {
   ...
   document.querySelector('.out-1').innerHTML = a1.includes(inputValue);
}
...
let myIncludes = a2.includes(inputValue);

    if(myIncludes){
        document.querySelector('.out-2').innerHTML = a2.indexOf(inputValue);
    }else {
        document.querySelector('.out-2').innerHTML = myIncludes;
    };
};
